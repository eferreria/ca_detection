view: create_model_net_cost {
  # derived_table: {
    ...
    #   #(
    #   sql_step:
    #       {% assign mdl_name = 'net_cost_forecast' %}
    ...
    #       --     ,  HOLIDAY_REGION =  -- Acceptable values are 'GLOBAL' or ['US', 'GB']. If enabled, update Step 4
    #             ,  AUTO_ARIMA = TRUE
    #       )
    ...
    #             , CURRENT_TIMESTAMP()
    #             , @{FORECAST_HORIZON}
    #             , 'FALSE' -- Update if HOLIDAY_REGION is enabled in Step 2.
    #             , '@{CONNECTION_NAME}'
    ...
    #           ,e.* EXCEPT(project_name)
    #           , TRUE AS is_latest_model_version
    #           FROM c
    #           JOIN e on c.project_name = e.project_name
